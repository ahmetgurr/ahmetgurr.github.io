    ...
    render() {
        ...
        return (
            <React.Fragment>
                                    ...
                                    <ul id="navbar_first_right">
                                        <li>
                                            <a href="#"
                                                ...
                                                <i className="fa-solid fa-user-check text-danger"></i>
                                            </a>
                                            ...
                                            <a href="#"
                                                ...
                                                aria-controls="offcanvasNavbar" ><i className="fa-solid fa-user-lock text-danger"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <nav
                    id="navbar_second_id"
                    className="navbar navbar-expand-md navbar-dark  fixed-top mb-5">
                    <div className="container">
                        <a
                        ...
                        <div className="collapse navbar-collapse" id="collapsibleNavId">
                            <ul className="navbar-nav me-auto mt-2 mt-lg-0">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="#project_id">
